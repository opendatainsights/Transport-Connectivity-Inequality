...
|--------|--------|-------|------|
| **Department for Transport (DfT)** | Connectivity Metrics (2025) | LSOA | [DfT Statistics](https://www.gov.uk/government/publications/transport-connectivity-metric/transport-connectivity-metric) |
